        ...
        <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block ps-3 bg-light sidebar collapse">
            <div class="position-sticky">
                <ul class="nav flex-column">
                    ...
                    {
                        (loggedInUser?.email && loggedInUser?.isAdmin === false) &&
                        <>
                            ...
                            <li class="nav-item pb-md-2" onClick={e => handleClick(e, <Comment></Comment>)}>
                                <a class="nav-link" href="">
                                    ...
                                    <span class="ms-2">Comment & Review</span>
                                </a>
                            </li>
                        </>
                    }
                    {
                        (loggedInUser?.email && loggedInUser?.isAdmin) &&
                        <>
                            <li class="nav-item pb-md-2" onClick={e => handleClick(e, <AddService></AddService>)}>
                                <a class="nav-link" href="">
                            ...
                            <li class="nav-item pb-md-2" onClick={e => handleClick(e, <ManageService></ManageService>)}>
                                <a class="nav-link" href="">
                            ...
                            <li class="nav-item pb-md-2" onClick={e => handleClick(e, <AddAdmin></AddAdmin>)}>
                                <a class="nav-link" href="">
                                    ...
                                    <span class="ms-2">Make Admin</span>
                                </a>
                            </li>
                        </>
                    }
